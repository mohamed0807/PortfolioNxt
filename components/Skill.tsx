...
const Skill = ({ skill, directionLeft }: Props) => {
  return (
    <div className="group relative cursor-pointer flex">
      ...
      />
      {/* <div className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-16 w-16 md:h-28 md:w-28 xl:w-32 xl:h-32 rounded-full z-0"> */}
